        ...
        <div id="wrapper">
            ...
            <div class="left side-menu">
                ...
                <div class="slimscroll-menu" id="remove-scroll">
                    ...
                    <div class="user-box">
                        <div class="user-img">
                            <img src="{{asset('uploads/profile_users').'/'.Auth::user()->profile_photo}}" alt="user-img" title="Mat Helme" class="rounded-circle img-fluid">
                        </div>
                        <h5><a href="#">{{Auth::user()->name}}</a> </h5>
                        <p class="text-muted">{{(auth()->user()->role == 2) ? "Admin" : "Customer"}}</p>
                    </div>
            ...
            <div class="content-page">
                        ...
                        <ul class="list-unstyled topbar-right-menu float-right mb-0">
                            ...
                            <li class="dropdown notification-list">
                                <a class="nav-link dropdown-toggle nav-user" data-toggle="dropdown" href="#" role="button"
                                   aria-haspopup="false" aria-expanded="false">
                                    <img src="{{asset('uploads/profile_users').'/'.Auth::user()->profile_photo}}" alt="user" class="rounded-circle"> <span class="ml-1">{{Auth::user()->name}}<i class="mdi mdi-chevron-down"></i> </span>
                                </a>
                ...
                <footer class="footer text-right">
                  {{\Carbon\Carbon::today()->format('Y')}} © Viper. - viper.com
                </footer>
